...
class UMLAttributeFactory:
    ...
    def create_all(self, cls: type) -> list[UMLAttribute]:
        """
        Create all UML _attributes for a given class. This method will return a list of UMLAttribute
...
def create_uml_attribute_factory() -> UMLAttributeFactory:
    type_hint_service = TypeHintService()
    return UMLAttributeFactory(type_hint_service)